        ...
        <>
            <div className="">
                        <div className="flex flex-col gap-1">
                            <span className="p-2 text-[20px] font-medium ">Discount & Voucher</span>

                            <span className="p-2 text-[16px] font-light text-gray-500">Add discount code to apply a discount
                                in your
                                purchase</span>
                        </div>
                        <div className="mt-4  space-y-2 ">
                            ...
                            <span className="text-center flex text-gray-500 text-[16px]">
                                Where can I find the discount code ? <svg width="24" height="24" viewBox="0 0 24 24"
