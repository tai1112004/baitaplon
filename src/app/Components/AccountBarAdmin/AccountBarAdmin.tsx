    ...
    return (
        <>
        {
            ...
            <div className="bg-neutral-100 w-[288px] rounded-lg h-[100vh]">
                        ...
                        <ul className="">
                            <li>
                                <div onClick={()=>handleTranferPage("/admin/statiscal")} className="c-menu-list-item" id="/account/persional"> 
                                    <FcStatistics />
                                    Thông Kê</div>

                            </li>
                            <li>
                                <div onClick={()=>handleTranferPage("/admin/user")} className="c-menu-list-item" id="/account/payment">
                                    <FaUserLock />
                                    Quản lý Người Dùng</div>

                            </li>
                            <li>
                                <div onClick={()=>handleTranferPage("/admin/product")} className="c-menu-list-item" id="/account/order"><svg width="24" height="24"
                            ...
                            <li>
                                <div onClick={()=>handleTranferPage("/admin/order")} className="c-menu-list-item" id="/account/order"><svg width="24" height="24"
                                        viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <path
                                            d="M5.18988 6.37994C4.99988 6.37994 4.79988 6.29994 4.65988 6.15994C4.36988 5.86994 4.36988 5.38994 4.65988 5.09994L8.28988 1.46994C8.57988 1.17994 9.05988 1.17994 9.34988 1.46994C9.63988 1.75994 9.63988 2.23994 9.34988 2.52994L5.71988 6.15994C5.56988 6.29994 5.37988 6.37994 5.18988 6.37994Z"
                                            fill="#444444" />
